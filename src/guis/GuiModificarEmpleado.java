...
public class GuiModificarEmpleado extends javax.swing.JFrame {
     ...
     */
    int indice;
    public GuiModificarEmpleado(int indice, GestorEmpleado gestorEmpleado) {
        initComponents();
        ge = gestorEmpleado;
        ...
        this.indice=indice;
        try{
            fechaNac=date.parse(ge.getEmpleados().get(indice).getFechaNacimiento());
            fechaIngreso=date.parse(ge.getEmpleados().get(indice).getFechaIngreso());
            this.jDateFecIngreso.setDate(fechaIngreso);
            this.jDateFecNacimiento.setDate(fechaNac);
        }catch(ParseException ex){

        }
      
        
        this.textFieldNombre.setText(ge.getEmpleados().get(indice).getNombre());
        this.textFieldApellidoMaterno.setText(ge.getEmpleados().get(indice).getApellidoMaterno());
        this.textFieldApellidoPaterno.setText(ge.getEmpleados().get(indice).getApellidoPaterno());
        this.textFieldRut.setText(ge.getEmpleados().get(indice).getRut());
        this.textFieldTelefono.setText(ge.getEmpleados().get(indice).getTelefono());
        this.textFieldHorasPorDia.setText(String.valueOf(ge.getEmpleados().get(indice).getHorasPorDia()));
        this.comboBoxSexo.setSelectedItem(ge.getEmpleados().get(indice).getSexo());
        this.comboBoxEstadoCivil.setSelectedItem(ge.getEmpleados().get(indice).getEstadoCivil());
        this.comboBoxAfp.setSelectedIndex(Integer.parseInt(ge.getEmpleados().get(indice).getCodAfiliacion()));
        this.comboBoxSalud.setSelectedIndex(Integer.parseInt(ge.getEmpleados().get(indice).getCodSalud()));
        this.comboBoxSeguro.setSelectedIndex(Integer.parseInt(ge.getEmpleados().get(indice).getCodSeguro()));
        this.comboBoxTrabajo.setSelectedIndex(Integer.parseInt(ge.getEmpleados().get(indice).getCodTrabajo()));
    ...
    private void initComponents() {
        ...
        comboBoxTrabajo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione Trabajo", "Carpintero", "Jornal", "Arquitecto", "Pintor", "Autocontro" }));
        ...
        jLabel10.setText("(ej. 10384325-1)");

        jLabel11.setText("(ej. 984059140)");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(comboBoxEstadoCivil, javax.swing.GroupLayout.Alignment.LEADING, 0, 1, Short.MAX_VALUE)
                            .addComponent(comboBoxSexo, javax.swing.GroupLayout.Alignment.LEADING, 0, 1, Short.MAX_VALUE)
                            .addComponent(jDateFecNacimiento, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)
                            .addComponent(textFieldHorasPorDia, javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(textFieldApellidoMaterno, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(textFieldApellidoPaterno, javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGap(24, 24, 24)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(comboBoxSalud, javax.swing.GroupLayout.Alignment.LEADING, 0, 1, Short.MAX_VALUE)
                            .addComponent(comboBoxAfp, javax.swing.GroupLayout.Alignment.LEADING, 0, 1, Short.MAX_VALUE)
                            .addComponent(comboBoxSeguro, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(comboBoxTrabajo, 0, 1, Short.MAX_VALUE))
        ...
        if (val.validarNombreApellido(textFieldNombre.getText()) == true ){
            ...
            if (val.validarNombreApellido(textFieldApellidoPaterno.getText()) == true){
                ...
                if (val.validarNombreApellido(textFieldApellidoMaterno.getText()) == true){
                    ...
                    if (val.validarRut(textFieldRut.getText()) == true && val.validarRutRepedito(textFieldRut.getText(), ge) != true || textFieldRut.getText().equals(ge.getEmpleados().get(indice).getRut())){
                                                    ...
                                                    if (comboBoxAfp.getSelectedIndex() != 0){
                                                        ...
                                                        if (comboBoxSalud.getSelectedIndex() != 0){
                                                            ...
                                                            if (comboBoxSeguro.getSelectedIndex() != 0){
                                                                ...
                                                                ge.modificarEmpleado(indice,empRut, nomb, apPaterno, apMaterno, fechaNacimiento, fechaIngreso, fono, sex,
                                                                        estCivil, hrsPorDia, codTrabjo, codSalud, codSeguro, codAfiliacion);
                                                                ge.getEmpleados().get(indice).setRut(empRut); 
                                                                ge.getEmpleados().get(indice).setNombre(nomb);
                                                                ge.getEmpleados().get(indice).setApellidoPaterno(apPaterno);
                                                                ge.getEmpleados().get(indice).setApellidoMaterno(apMaterno);
                                                                ge.getEmpleados().get(indice).setFechaNacimiento(fechaNacimiento);
                                                                ge.getEmpleados().get(indice).setFechaIngreso(fechaIngreso);
                                                                ge.getEmpleados().get(indice).setTelefono(fono);
                                                                ge.getEmpleados().get(indice).setSexo(sex);
                                                                ge.getEmpleados().get(indice).setEstadoCivil(estCivil);
                                                                ge.getEmpleados().get(indice).setHorasPorDia(hrsPorDia);
                                                                ge.getEmpleados().get(indice).setCodTrabajo(codTrabjo);
                                                                ge.getEmpleados().get(indice).setCodSalud(codSalud);
                                                                ge.getEmpleados().get(indice).setCodSeguro(codSeguro);
                                                                ge.getEmpleados().get(indice).setCodAfiliacion(codAfiliacion);
